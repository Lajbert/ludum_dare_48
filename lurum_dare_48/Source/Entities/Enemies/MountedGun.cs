...
{
    class MountedGun : PhysicalEntity
    {
        ...
        private Vector2 middleOffset = new Vector2(8, 8);

        public MountedGun(AbstractScene scene, Vector2 position, Direction direction, int triggerWidth, int triggerHeight, int triggerXoffset, int triggerYoffset) : base (scene.LayerManager.EntityLayer, null, position)
        {
            AddComponent(new Sprite(this, AssetUtil.CreateRectangle(Config.GRID, Color.Crimson)));
